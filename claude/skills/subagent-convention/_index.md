...
> **지시사항 수정/추가 시** 이 인덱스를 참조하여 관련 문서를 함께 업데이트하세요.
...
- **병렬 실행 효율성 분석** (2.0x↑: 🟢, 1.5~2.0x: 🟡, 1.5x↓: 🔴)
- **프로세스 개선 논의** (Orchestrator와 논의 → 사용자에게 제안)
- JSON 보고서 스키마

### templates/execution-report.md
- 콘솔 출력 보고서 템플릿
- 필수 섹션: 요약, 작업목록, 변경파일, **단계별 소요시간**, **병목분석**, **병렬효율성**, **프로세스개선제안**
