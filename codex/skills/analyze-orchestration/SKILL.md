...
description: Claude command `/analyze:orchestration` 대응 스킬. Claude의 `/analyze:orchestration` 명령을 Codex에서 skill로 사용할 때 대응 매핑으로 사용한다.
---
...
- Claude command `/analyze:orchestration` 대응 스킬.
- Claude의 `/analyze:orchestration`를 Codex에서 같은 의도로 수행해야 할 때
