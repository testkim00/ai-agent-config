---
name: env-remove
description: 등록된 환경변수(DB, 토큰) 삭제 Claude의 `/env:remove` 명령을 Codex에서 skill로 사용할 때 대응 매핑으로 사용한다.
---
...
- 등록된 환경변수(DB, 토큰) 삭제
- Claude의 `/env:remove`를 Codex에서 같은 의도로 수행해야 할 때

## source mapping

- Claude command: `/env:remove`
- Source file: `claude/commands/env/remove.md`
