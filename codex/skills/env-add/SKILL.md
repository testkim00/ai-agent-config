---
name: env-add
description: 환경변수(DB 접속정보, API 토큰) 추가 Claude의 `/env:add` 명령을 Codex에서 skill로 사용할 때 대응 매핑으로 사용한다.
---
...
- 환경변수(DB 접속정보, API 토큰) 추가
- Claude의 `/env:add`를 Codex에서 같은 의도로 수행해야 할 때

## source mapping

- Claude command: `/env:add`
- Source file: `claude/commands/env/add.md`
