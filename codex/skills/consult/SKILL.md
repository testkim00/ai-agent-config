---
name: consult
description: Claude command `/consult` 대응 스킬. Claude의 `/consult` 명령을 Codex에서 skill로 사용할 때 대응 매핑으로 사용한다.
---
...
- Claude command `/consult` 대응 스킬.
- Claude의 `/consult`를 Codex에서 같은 의도로 수행해야 할 때

## source mapping

- Claude command: `/consult`
- Source file: `claude/commands/consult.md`
